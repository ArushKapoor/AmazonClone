          ...
          <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <br />
                <span className="text-white footer__span">Press Releases</span>
                <br />
              ...
              <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <br />
                <span className="text-white footer__span">Sell on Amazon</span>
                <br />
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <br />
                <span className="text-white footer__span">Returns Centre</span>
                <br />
                <span className="text-white footer__span">
