  ...
  return (
    ...
    to login page if clicked */}
      ...
      <nav
        ...
        style={{ "background-color": "#232F3E", height: "40px" }}
      >
        <div className="d-flex align-items-center justify-content-between">
          <div>
            ...
            >
              <span
                class="bi text-decoration-none bi-list fw-bold"
            ...
            <a
              href="#bestSeller"
              className="ms-3 text-decoration-none btn btn-outline-light"
              style={{ "font-size": "14px" }}
            >
              Best Seller
            </a>
      ...
      <div
        className="h-100 position-fixed bg-dark text-white top-0 bottom-0 start-0 overflow-scroll"
        style={{
          "z-index": "10000",
          width: isOpen ? "0px" : "25rem",
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(0,0,0,0.9)", "z-index": "9999" }}
      ></div>
    </>
  );
}
